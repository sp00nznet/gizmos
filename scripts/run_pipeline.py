...
def discover_functions(pe_data, info, iat_map):
    ...
    # Seed the PE entry point by hand. Nothing calls it, and this Borland CRT
    # startup does not open with `push ebp; mov ebp, esp`, so neither heuristic
    # finds it -- and without it the recompiled program has nowhere to start.
...
def generate_recomp_files(functions, iat_map, output_dir, split_size=1000, func_names=None):
    ...
    while func_idx < total:
        ...
        with open(filepath, 'w') as f:
            f.write(f"/* Auto-generated by the Gizmos & Gadgets recompiler -- DO NOT EDIT */\n")
